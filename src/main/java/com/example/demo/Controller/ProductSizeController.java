...
import com.example.demo.Dao.FillProSizeDao;
...
import com.example.demo.Model.ProductSizeModel;
...
//		Size size = sizeDao.getById(Integer.parseInt(entity.getSizeId()));
		...
		Size size = sizeDao.getOne(Integer.parseInt(entity.getSizeId()));
...
//		ProductSize entity = dao.getById(id);
		ProductSize entity = dao.getOne(id);
		dao.delete(entity);
		return "redirect:/admin/productsizeForm/form";
	}
