...
<body>
	...
	<ul
		...
		<a
			...
			href="http://localhost:8080/admin/employeeTable/list">
...
<hr class="sidebar-divider">
		<li class="nav-item">
		<a class="nav-link collapsed" href="http://localhost:8080/index"
			
			aria-expanded="true" aria-controls="collapseUtilities"> <i class="fas fa-house-damage"></i> <span>Trang chủ</span>
		</a></li>
		<!-- Divider -->
		<hr class="sidebar-divider">
