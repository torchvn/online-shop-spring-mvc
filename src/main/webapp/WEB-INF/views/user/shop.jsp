				...
				<div class="bg-light p-4 mb-30">
					<form>
						...
						<c:forEach var="item" begin="1" items="${color}">
							<div
								class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
								<input type="checkbox" class="custom-control-input" id="color-${item.group.id}">
								<label class="custom-control-label" for="color-${item.group.id}">${item.group.name}</label>
				...
				<div class="bg-light p-4 mb-30">
					<form>
						...
						<c:forEach var="item" items="${size}">
							<div
								class="custom-control custom-checkbox d-flex align-items-center justify-content-between mb-3">
								<input type="checkbox" class="custom-control-input" id="size-${item.group.id}">
								<label class="custom-control-label" for="size-${item.group.id}">${item.group.name}</label>
								<span class="badge border font-weight-normal">${item.count}</span>
							</div>
						</c:forEach>
