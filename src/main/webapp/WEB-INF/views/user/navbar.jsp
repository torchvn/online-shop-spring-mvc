		...
		<div
			...
			<div class="col-lg-4">
				<a href="/index" class="text-decoration-none"> <span
					class="h1 text-uppercase text-primary bg-dark px-2">SWD</span> <span
					class="h1 text-uppercase text-dark bg-primary px-2 ml-n1">391</span>
				</a>
			</div>
				...
				<nav
					...
					<div class="navbar-nav w-100">						
						<c:forEach var="item" items="${procate}">
							<a href="http://localhost:8080/shop/category/${item.group.id}" class="nav-item nav-link">${item.group.name}</a>
						</c:forEach>						
					</div>
				</nav>
			</div>
			<div class="col-lg-9">
				<nav
					...
					<a href="" class="text-decoration-none d-block d-lg-none"> <span
						class="h1 text-uppercase text-dark bg-light px-2">SWD</span> <span
						class="h1 text-uppercase text-light bg-primary px-2 ml-n1">391</span>
					</a>
					...
					<div class="collapse navbar-collapse justify-content-between"
						...
						<div class="navbar-nav mr-auto py-0">
							...
							<security:authorize access="hasRole('ROLE_ADMIN')">  
 								<a href="http://localhost:8080/admin/employeeTable/list" class="nav-item nav-link">Quản lý</a>
							</security:authorize>
						</div>
