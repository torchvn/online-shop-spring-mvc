	...
	<div class="container-fluid bg-dark text-secondary mt-5 pt-5">
		<div class="row px-xl-5 pt-5">
			<div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
				...
				<p class="mb-4">Cảm ơn các bạn đã quan tâm và mua sắm tại website của chúng tôi</p>
				<p class="mb-2">
					<i class="fa fa-map-marker-alt text-primary mr-3"></i>Shop Ecommerce
				</p>
				<p class="mb-2">
					<i class="fa fa-envelope text-primary mr-3"></i>test@gmail.com
				</p>
				<p class="mb-0">
					<i class="fa fa-phone-alt text-primary mr-3"></i>0987654321
				</p>
			</div>
