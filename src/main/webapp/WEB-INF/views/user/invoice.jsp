								...
								<tr>
									<td align="left"
										...
										<p
											...
											Cảm ơn bạn đã đặt hàng tại <b style="color: orange;">SWD391</b>.
											Hãy kiểm tra lại thông tin đặt hàng. Nếu có bất kì thắc mắc nào hãy liên hệ với nhân viên hỗ trợ theo số máy 0987654321. Cảm ơn!
										</p>
									</td>
								</tr>
								<tr>
											...
											<table align="left" border="0" cellpadding="0"
												...
												<tr>
													<td align="right" valign="top"
														...
														<p>14 ngày kể từ thời gian nhận đơn hàng.</p>
													</td>
												</tr>
											</table>
										</div>
								...
								<tr>
									<td align="center"
										...
										<h2
											...
											Quay trở lại trang thông tin.</h2>
									</td>
								</tr>
								<tr>
										...
										<table border="0" cellspacing="0" cellpadding="0">
											<tr>
												<td align="center" style="border-radius: 5px;"
													...
													style="font-size: 18px; font-family: Open Sans, Helvetica, Arial, sans-serif; color: #ffffff; text-decoration: none; border-radius: 5px; background-color: #F44336; padding: 15px 30px; border: 1px solid #F44336; display: block;">Quay lại <i class="fas fa-hand-point-left"></i></a></td>
											</tr>
										</table>
									</td>
								</tr>
								...
								<tr>
									<td align="left"
										...
										<p
											...
											Nếu bạn không tạo tài khoản bằng địa chỉ email này, vui lòng bỏ qua email này hoặc <a href="#" target="_blank"
												style="color: #777777;">huỷ đăng kí</a>.
										</p>
									</td>
								</tr>
							</table>
